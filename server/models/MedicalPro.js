...
// hash user password
MedicalProSchema.pre('save', async function (next) {
...
MedicalProSchema.methods.isCorrectPassword = async function (password) {
  return await bcrypt.compare(password, this.password);
};

const MedicalPro = mongoose.model('MedicalPro', medicalProSchema);

module.exports = MedicalPro;